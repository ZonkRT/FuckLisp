...
(defun family() 
 ...
 ;   (write "before reading lines")
    ...
    ;    (write "inside loop")
			...
			(if (string= (FIRST words) "X")
				(if (= (length words) 4) 
					(when (string= (THIRD words) "parent")
